...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-white font-sans text-black overflow-x-hidden" style={{ fontFamily: 'Inter, -apple-system, sans-serif' }}>
      ...
      {/* Split Hero Section */}
      <main className="max-w-7xl mx-auto px-8 pt-24 pb-12 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center min-h-[75vh]">
        ...
        <motion.div
          ...
          className="w-full h-[600px] rounded-3xl relative overflow-hidden group shadow-2xl"
        >
